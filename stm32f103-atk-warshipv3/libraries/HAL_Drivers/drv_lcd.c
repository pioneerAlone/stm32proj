...
//注意设置时STM32内部会右移一位对其!
#define LCD_ILI9341_BASE        ((rt_uint32_t)(0x6C000000 | 0x000007FE))
...
void _lcd_low_level_init(void)
{
  ...
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
	...
	FSMC_ReadWriteTim.AddressSetupTime = 0x01;
	FSMC_ReadWriteTim.AddressHoldTime = 0x00;
	FSMC_ReadWriteTim.DataSetupTime = 0x0f;
  ...
  /* ExtTiming */
	...
	FSMC_WriteTim.AddressSetupTime = 0x00;
	FSMC_WriteTim.AddressHoldTime = 0x00;
	FSMC_WriteTim.DataSetupTime = 0x03;
...
MSH_CMD_EXPORT(ili9341_id,get ili9341 id);
